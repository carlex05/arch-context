  ...
  public void migrate() {
    ...
    try (Connection c = connect();
      ...
      throw new IllegalStateException(
          "Cannot migrate SQLite database at " + dbPath + ": " + e.getMessage(), e);
    }
  }

  private void run(Connection c, String resource) throws Exception {
    try (InputStream in =
        getClass().getClassLoader().getResourceAsStream("db/migration/" + resource)) {
      ...
      try (PreparedStatement ps =
          c.prepareStatement("INSERT OR IGNORE INTO schema_migrations(version) VALUES (?)")) {
